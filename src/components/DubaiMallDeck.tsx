...
export function DubaiMallDeck() {
  ...
  function beginTransition() {
    ...
    safetyTimerRef.current = setTimeout(() => { isTransitioningRef.current = false; }, 3000);
  }
  ...
  useGSAP(() => {
    ...
    const showChapter = (idx: number, instant = false) => {
      ...
      chapters.forEach((c, i) => {
        gsap.killTweensOf(c); gsap.killTweensOf(imgCards[i]); gsap.killTweensOf(bgLayers[i]);
      });
      chapters.forEach((c, i) => { if (i !== idx && i !== prev) gsap.set(c, { opacity: 0, y: 0 }); });
      imgCards.forEach((c, i) => { if (i !== idx && i !== prev) gsap.set(c, { opacity: 0 }); });
    ...
    const goToWhy = () => {
      ...
      tl
        .to("#hero",        { opacity: 0, y: -48, scale: 0.97, duration: 0.75, ease: "power2.in" })
    ...
    const goToHero = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#why-section", { opacity: 0, y: 48, scale: 1.02, duration: 0.7, ease: "power2.in" })
    ...
    const animateRetailIntroIn = () => {
      ...
      tl
        .to("#ri-eyebrow",  { opacity: 1, y: 0, duration: 0.7, ease: "power3.out" }, 0.1)
    ...
    const goToRetailIntro = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#why-section",  { opacity: 0, y: -48, scale: 0.97, duration: 0.75, ease: "power2.in" })
    ...
    const goToWhyFromRetail = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#retail-intro", { opacity: 0, y: 40, duration: 0.55, ease: "power2.in" })
    ...
    const goToRetailBrands = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#retail-intro", { opacity: 0, y: -40, duration: 0.6, ease: "power2.in" })
    ...
    const goToRetailIntroFromBrands = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#retail-brands", { opacity: 0, y: 30, duration: 0.5, ease: "power2.in" })
    ...
    const goToEcosystem = () => {
      ...
      setTimeout(() => { ecoJustEnteredRef.current = false; }, 900);
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#retail-brands", { opacity: 0, y: -40, duration: 0.55, ease: "power2.in" })
        .to("#sectionWipe",   { opacity: 1, duration: 0.18 }, 0.4)
        .call(() => {
          gsap.set("#retail-brands", { opacity: 0, pointerEvents: "none" });
    ...
    const goToRetailBrandsFromEco = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#ecosystem",   { opacity: 0, y: 40, duration: 0.5, ease: "power2.in" })
        .to("#sectionWipe", { opacity: 1, duration: 0.18 }, 0.38)
        .call(() => {
    ...
    const animateDiningIntroIn = () => {
      ...
      const tl = gsap.timeline();
      tl
        .to(".di-eyebrow", { opacity: 1, y: 0, duration: 0.65, ease: "power3.out" }, 0)
    ...
    const goToDiningIntro = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#ecosystem",   { opacity: 0, y: -44, duration: 0.6, ease: "power2.in" })
    ...
    const goToDiningGallery = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#dining-intro", { opacity: 0, y: -42, duration: 0.6, ease: "power2.in" })
        .to("#sectionWipe",  { opacity: 1, duration: 0.18 }, 0.45)
        .call(() => {
    ...
    const goToDiningIntroBack = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#dining-gallery", { opacity: 0, y: 40, duration: 0.55, ease: "power2.in" })
        .to("#sectionWipe",    { opacity: 1, duration: 0.18 }, 0.4)
        .call(() => {
    ...
    const goToEcoFromDining = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#dining-intro", { opacity: 0, y: 40, duration: 0.55, ease: "power2.in" })
        .to("#sectionWipe",  { opacity: 1, duration: 0.18 }, 0.4)
        .call(() => {
    ...
    const goToAttractions = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#dining-gallery",    { opacity: 0, y: -42, duration: 0.6, ease: "power2.in" })
        .to("#sectionWipe",       { opacity: 1, duration: 0.18 }, 0.45)
        .call(() => {
          gsap.set("#dining-gallery",    { opacity: 0, pointerEvents: "none" });
          gsap.set("#dg-header",         { opacity: 0 });
    ...
    const goFromAttractionsBack = () => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to("#attractions-intro", { opacity: 0, y: 40, duration: 0.55, ease: "power2.in" })
        .to("#sectionWipe",       { opacity: 1, duration: 0.18 }, 0.4)
        .call(() => {
    ...
    const animateAttractionsIn = () => {
      ...
      const tl = gsap.timeline();
      tl
        .to(".ai-eyebrow", { opacity: 1, y: 0, duration: 0.65, ease: "power3.out" }, 0)
    ...
    const jumpToSection = (targetSec: number) => {
      ...
      const tl = gsap.timeline({ onComplete: endTransition });
      tl
        .to(SECTION_IDS.filter((_, i) => i === prevSec), { opacity: 0, duration: 0.45, ease: "power2.in" })
    ...
    loader
      ...
      .to("#ringProgress", {
        strokeDashoffset: 0, duration: 2.1, ease: "power1.inOut",
      ...
      .to("#iconWrap", {
        scale: fillScale, duration: 0.85, ease: "power3.in",
        transformOrigin: "center center",
        onStart() { gsap.set("#hero", { opacity: 1, pointerEvents: "all" }); },
      }, 3.62)
      ...
      .call(() => { wheelReadyRef.current = true; }, undefined, 6.1);
  }, { scope: containerRef });
  ...
  useWheelHandler({
    onScroll: (dir) => {
      ...
      if (sec === 0) {
        ...
        if (dir < 0) goFromAttractionsBackRef.current();
      }
    },
    cooldown: 700,
  });
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "var(--c-void)", WebkitFontSmoothing: "antialiased",
      }}
    >
      <GrainOverlay />
      <SectionWipe />
      ...
      <GlobalNav
        ...
        onPlanVisit={()  => jumpToSectionRef.current(7)}
      />
      <HeroSection />
      <WhySection />
      <RetailIntroSection />
