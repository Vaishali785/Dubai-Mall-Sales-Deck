    ...
    >
      ...
      <div
        ...
        style={{
          ...
          color: "rgba(200,169,110,.5)", fontWeight: 400, gap: 10,
        }}
      >
        05 — Dining
        <span style={{ width: 24, height: 1, background: "rgba(200,169,110,.3)", display: "block" }} />
      </div>
      ...
      <p
        ...
        style={{
          zIndex: 1, fontFamily: "var(--f-sans)", fontSize: 10, fontWeight: 300,
          letterSpacing: ".36em", textTransform: "uppercase",
          color: "var(--c-gold)", marginBottom: 28, gap: 18,
      ...
      <h2
        id="di-headline"
        style={{
          fontFamily: "var(--f-serif)", fontSize: "clamp(44px,6.5vw,86px)",
      ...
      <div
        ...
        style={{ zIndex: 1, gap: 20, width: 200, margin: "24px auto 26px", opacity: 0 }}
      >
      ...
      <p
        id="di-sub"
        style={{
          fontFamily: "var(--f-sans)", fontSize: "clamp(13px,1.35vw,16px)",
      ...
      >
        From Michelin-inspired tasting menus to vibrant waterfront cafés,<br />
        Dubai Mall offers a world-class culinary destination where<br />
        ...
        {[
          ...
          <div key={i} style={{ display: "contents" }}>
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{
                fontFamily: "var(--f-display)", fontSize: "clamp(32px,3.8vw,48px)",
                fontWeight: 700, color: "var(--c-white)", letterSpacing: "-.02em", lineHeight: 1,
              }}>
                {stat.num}
                <sub style={{
                  fontSize: ".42em", color: "var(--c-gold)",
                  fontFamily: "var(--f-serif)", fontStyle: "italic", fontWeight: 300, verticalAlign: "super",
                }}>{stat.sup}</sub>
              </div>
              <div style={{
                fontFamily: "var(--f-sans)", fontSize: 9, fontWeight: 300,
                letterSpacing: ".18em", textTransform: "uppercase",
                color: "var(--c-muted)", marginTop: 8,
              }}>{stat.label}</div>
            </div>
          </div>
        ))}
      ...
      >
        ...
        <span style={{ fontFamily: "var(--f-sans)", fontSize: 9, fontWeight: 300, letterSpacing: ".26em", textTransform: "uppercase", color: "rgba(200,169,110,.55)" }}>
          Explore Dining
        </span>
      </div>
    </div>
