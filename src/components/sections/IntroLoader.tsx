import { IntroLoaderMark } from "@/components/svgs/IntroLoaderMark";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "var(--c-gold)", opacity: 0 }}
      />
      ...
      <div
        ...
        style={{ marginTop: 46, opacity: 0, transform: "translateY(14px)" }}
      >
        <p style={{
        ...
        <h1 style={{
          ...
          The World's Most Visited<br />Retail Destination
        </h1>
      </div>

      <div
        className="loader-bar-outer absolute left-1/2 -translate-x-1/2 z-[2]"
        style={{ bottom: 52, width: 180 }}
      >
