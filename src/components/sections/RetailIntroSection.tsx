  ...
  return (
    ...
    >
      ...
      <p
        ...
        style={{
          fontFamily: "var(--f-sans)", fontSize: 10, fontWeight: 300,
      ...
      <div
        ...
        style={{ gap: 20, width: 200, margin: "24px auto 28px" }}
      >
      ...
      >
        ...
        from luxury fashion houses to global retail leaders,<br />
        all under one architecturally iconic roof.
      </p>

      <div id="ri-stats" className="flex items-center justify-center" style={{ gap: 56 }}>
        <div style={{ textAlign: "center" }}>
          <div style={{ fontFamily: "var(--f-display)", fontSize: "clamp(30px,3.5vw,44px)", fontWeight: 700, color: "var(--c-white)", letterSpacing: "-.02em", lineHeight: 1 }}>
            1,200<sub style={{ fontSize: ".42em", color: "var(--c-gold)", fontFamily: "var(--f-serif)", fontStyle: "italic", fontWeight: 300, verticalAlign: "super" }}>+</sub>
          </div>
          <div style={{ fontFamily: "var(--f-sans)", fontSize: 9, fontWeight: 300, letterSpacing: ".18em", textTransform: "uppercase", color: "var(--c-muted)", marginTop: 7 }}>Retail Stores</div>
        </div>
        <div style={{ width: 1, height: 36, background: "rgba(200,169,110,.18)" }} />
        <div style={{ textAlign: "center" }}>
          <div style={{ fontFamily: "var(--f-display)", fontSize: "clamp(30px,3.5vw,44px)", fontWeight: 700, color: "var(--c-white)", letterSpacing: "-.02em", lineHeight: 1 }}>
            200<sub style={{ fontSize: ".42em", color: "var(--c-gold)", fontFamily: "var(--f-serif)", fontStyle: "italic", fontWeight: 300, verticalAlign: "super" }}>+</sub>
          </div>
          <div style={{ fontFamily: "var(--f-sans)", fontSize: 9, fontWeight: 300, letterSpacing: ".18em", textTransform: "uppercase", color: "var(--c-muted)", marginTop: 7 }}>Luxury Brands</div>
        </div>
        <div style={{ width: 1, height: 36, background: "rgba(200,169,110,.18)" }} />
        <div style={{ textAlign: "center" }}>
          <div style={{ fontFamily: "var(--f-display)", fontSize: "clamp(30px,3.5vw,44px)", fontWeight: 700, color: "var(--c-white)", letterSpacing: "-.02em", lineHeight: 1 }}>
            5<sub style={{ fontSize: ".42em", color: "var(--c-gold)", fontFamily: "var(--f-serif)", fontStyle: "italic", fontWeight: 300, verticalAlign: "super" }}>M</sub>
          </div>
          <div style={{ fontFamily: "var(--f-sans)", fontSize: 9, fontWeight: 300, letterSpacing: ".18em", textTransform: "uppercase", color: "var(--c-muted)", marginTop: 7 }}>Sq Ft Retail</div>
        </div>
      </div>
      ...
      <div
        ...
        style={{ bottom: 36, left: "50%", transform: "translateX(-50%)", gap: 8 }}
      >
        ...
        <span style={{ fontFamily: "var(--f-sans)", fontSize: 9, fontWeight: 300, letterSpacing: ".26em", textTransform: "uppercase", color: "rgba(200,169,110,.5)" }}>Continue</span>
      </div>
    </div>
  );
}
