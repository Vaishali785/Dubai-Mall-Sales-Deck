...
const CARDS: DiningCard[] = [
  {
    ...
    tag: "Waterfront · Dubai Fountain Views",
  ...
  },
  {
    ...
    tag: "Fine Dining · Fashion Avenue",
    title: "Michelin-Inspired\nCulinary Experiences",
  },
  {
    size: "small",
    zigzag: "up",
  ...
  },
  {
    ...
    tag: "Panoramic Dining · Level 4",
    title: "Skyline Views\nOver Dubai",
  },
  {
    size: "small",
    zigzag: "up",
    img: "https://images.unsplash.com/photo-1551218808-94e220e084d2?w=800&q=80",
    tag: "Bar & Lounge",
    title: "Curated Cocktails",
  },
];

interface DiningGallerySectionProps {
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          zIndex: 10, padding: "26px 52px", opacity: 0,
      ...
      <div
        ...
        style={{
          ...
          scrollBehavior: "auto", cursor: "grab",
      ...
      >
        <div
          ...
          style={{
            ...
            padding: "0 8vw", gap: 0, height: "100%", minWidth: "max-content",
          }}
        >
          {CARDS.map((card, i) => (
            <div
