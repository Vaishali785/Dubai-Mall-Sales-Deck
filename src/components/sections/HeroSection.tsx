...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div
        id="hero-video-panel"
        className="absolute left-0 top-0 bottom-0 z-[1] overflow-hidden hero-video-panel"
        style={{ width: "65%" }}
      >
        <video
          id="hero-vid"
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent 60%, rgba(6,5,4,.9) 100%)",
          }}
        />
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(to bottom, rgba(6,5,4,.45) 0%, transparent 18%, transparent 72%, rgba(6,5,4,.4) 100%)",
          }}
        />
        <div
          className="absolute inset-0"
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 50% 210% at 25% 50%, rgba(6,5,4,0) 75%, rgba(0,0,0,.4) 80%, rgba(6,5,4,.82) 85%)",
        }}
      />
      <div
      ...
      >
        ...
        <p id="hSub" style={{
          ...
          More than a shopping center.<br />
          Where brands, culture, and experiences<br />
