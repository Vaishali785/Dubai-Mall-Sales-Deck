export function AttractionsIntroSection() {
	return (
		...
		>
			...
			<div className="ai-divider flex items-center relative" style={{ zIndex: 2, gap: 20, width: 200, margin: "24px auto 28px", opacity: 0 }}>
			...
			>
				From the mesmerising Dubai Fountain to the underwater wonders of the Dubai Aquarium, experience world-class entertainment and cultural
				landmarks that transform every visit into an unforgettable journey.
			</p>

			<div className="ai-stats flex items-center justify-center relative" style={{ zIndex: 2, gap: 56, opacity: 0, transform: "translateY(14px)" }}>
				{[
